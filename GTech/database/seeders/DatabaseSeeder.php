...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $orders = [
            ['user_id' => User::where('email', 'customer@gtech.com')->first()->id, 'order_date' => '2024-11-20 12:00:00', 'status' => 'pending', 'total_price' => 32],
            ['user_id' => User::where('email', 'john.doe@gtech.com')->first()->id, 'order_date' => '2024-11-10 12:00:00', 'status' => 'completed', 'total_price' => 500],
            ['user_id' => User::where('email', 'jane.smith@gtech.com')->first()->id, 'order_date' => '2024-11-12 12:00:00', 'status' => 'pending', 'total_price' => 150],
            ['user_id' => User::where('email', 'alice.brown@gtech.com')->first()->id, 'order_date' => '2024-11-15 12:00:00', 'status' => 'completed', 'total_price' => 300],
            ['user_id' => User::where('email', 'bob.white@gtech.com')->first()->id, 'order_date' => '2024-10-17 12:00:00', 'status' => 'shipping', 'total_price' => 450],
            ['user_id' => User::where('email', 'tom.green@gtech.com')->first()->id, 'order_date' => '2024-10-19 12:00:00', 'status' => 'cancelled', 'total_price' => 100],
            ['user_id' => User::where('email', 'sarah.blue@gtech.com')->first()->id, 'order_date' => '2024-10-05 12:00:00', 'status' => 'completed', 'total_price' => 600],
            ['user_id' => User::where('email', 'michael.red@gtech.com')->first()->id, 'order_date' => '2024-10-01 12:00:00', 'status' => 'pending', 'total_price' => 200],
            ['user_id' => User::where('email', 'emily.yellow@gtech.com')->first()->id, 'order_date' => '2024-9-08 12:00:00', 'status' => 'completed', 'total_price' => 250],
            ['user_id' => User::where('email', 'chris.orange@gtech.com')->first()->id, 'order_date' => '2024-9-06 12:00:00', 'status' => 'completed', 'total_price' => 700],
            ['user_id' => User::where('email', 'paul.purple@gtech.com')->first()->id, 'order_date' => '2024-9-11 12:00:00', 'status' => 'shipping', 'total_price' => 350],
